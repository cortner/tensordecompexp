"""Block ALS CP: updates full A and B each iteration; rank sweep with lambda updates enabled."""
...
if __name__ == "__main__":
    ...
    with open("als_false_whole_rank_sweep_results.json", "w") as f_out:
        json.dump(all_results, f_out, indent=4)

    print("\nAll ALS runs complete. Results saved to als_false_whole_rank_sweep_results.json")
