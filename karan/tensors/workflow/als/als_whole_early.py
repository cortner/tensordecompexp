"""Block ALS CP with early stopping on training RMSE enabled during the rank sweep."""
...
if __name__ == "__main__":
    ...
    for idx, C in enumerate(C_matrices):
        ...
        for R in range(1, 21):  # sweep ranks 1 -> 20
            ...
            metrics, coeffs, config, savedir = run_als_experiment(
                ...
                random_seed=42,
                outdir="als_results",
                use_lambda=True,      # set True to enable lambda updates and normalization
    ...
    with open("als_true_early_whole_rank_sweep_results.json", "w") as f_out:
        json.dump(all_results, f_out, indent=4)

    print("\nAll ALS runs complete. Results saved to als_true_early_whole_rank_sweep_results.json")
